...
export default function Forest(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/forest.gltf')
  ...
  rotation={[-0.077, 0, 0]}
  scale={[1, 1, 1.613]}
  onClick={() => (window.location.href = '/SaveForest')} // Navigate to /3D
>
...
>
  ...
  {font && (
    <Tag
      position={[0, 2.5, 0]}  // Relocate to be higher above the object for better visibility
      font={font}
      text="SaveForest Button"
      fontSize={1.5} // Increase the font size
    />
  )}
</group>
...
>
  <group name="transform10" />
                ...
                <group name="fire3polySurface161">
                  ...
                  <group name="fire3polySurface163" position={[4.488, 0.119, 0.215]} rotation={[0.307, 0.55, 2.265]}>
                  ...
                  <group name="polySurface163_1" position={[3.314, -0.024, 0.894]} rotation={[0.307, 0.55, 2.265]} scale={0.23}>
                  ...
                  <group name="polySurface183" position={[3.115, 0.007, 0.773]} rotation={[0.4, -0.03, 2.564]} scale={0.23}>
                  ...
                  <group name="polySurface184" position={[3.524, 0.007, 0.711]} rotation={[0.175, 0.95, 2.86]} scale={0.23}>
                  ...
                  <group name="polySurface185" position={[3.524, 0.135, 0.711]} rotation={[1.709, 1.088, 1.37]} scale={0.23}>
    ...
    >
      ...
      {font && <Tag position={[0, 1.5, 0]} font={font} text="ClickOn Fire to Time-Travel" />}
    </group>
              </group>
            </group>
          </group>
